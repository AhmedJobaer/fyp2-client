                    ...
                    <table className="table  w-full">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <th>
                                    <button className="btn border-none text-white bg-green-500 btn-xs">pending</button>
                            ...
                            <tr>
                                ...
                                <th>
                                    <button className="btn text-white border-none bg-green-500 btn-xs">pending</button>
                                    <button className="btn border-none ml-2 text-white bg-red-500 btn-xs">cancel</button>
                                </th>
                            </tr>
                            <tr>
