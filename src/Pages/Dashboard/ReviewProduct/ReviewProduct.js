    ...
    return (
        <div>
            <div>
                ...
                <p className='text-5xl text-center  font-lobster font-bold  mt-7 mb-14'> Your <span className='text-green-500'>Review</span> Items. </p>
                    ...
                    <table className="table  w-full">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <th>
                                    <button className="btn border-none text-white bg-green-500 btn-xs">share</button>
                            ...
                            <tr>
                                ...
                                <th>
                                    <button className="btn text-white border-none bg-green-500 btn-xs">share</button>
                                    <button className="btn border-none ml-2 text-white bg-red-500 btn-xs">cancel</button>
                                </th>
                            </tr>
                            <tr>
